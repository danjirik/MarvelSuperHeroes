...
import { Shield, Zap, Flame, Users, BookOpen, Calculator, Play } from 'lucide-react';
...
export default function Calculators() {
  ...
  const teamworkStatus = () => {
    // We need to tap creatures with total power >= teamworkTarget.
    // One player can fully use their creatures. Let's see:
    ...
    if (mySufficient) {
      return {
        ...
        advice: 'Výborně! Můžete tapnout své jednotky na aktivaci Teamworku a váš partner (Hráč B) si ponechá všechny své blockery připravené pro obranu týmu. Tím eliminujete riziko otevření obrany!'
      };
      ...
      return {
        possible: false, // In MTG rules, a SINGLE player must control the creatures tapped for teamwork!
    ...
    <div className="calculators-container">
      ...
      <div className="glass-panel" style={{ padding: '1.5rem', marginBottom: '1.5rem' }}>
        <h2 style={{ marginBottom: '0.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          2HG Kalkulačka a Akademie mechanik
        </h2>
      ...
      {/* Main Grid: Left Calculators, Right Academy */}
        ...
        <div>
          ...
          <div className="calc-box">
            ...
            <div className="calc-result" style={{ borderColor: 'rgba(236,72,153,0.3)', background: 'rgba(236,72,153,0.06)' }}>
              <div>
                <span style={{ fontSize: '0.75rem', color: '#9ca3af', textTransform: 'uppercase' }}>Ztráta životů v 1v1:</span>
                <div style={{ fontSize: '1.5rem', fontWeight: 800, color: '#fff' }}>{widowResult.standard} životů</div>
              </div>
              <div style={{ textTransform: 'uppercase', fontSize: '0.8rem', color: '#9ca3af', fontWeight: 800 }}>vs</div>
            ...
            <p style={{ fontSize: '0.78rem', color: '#9ca3af', marginTop: '0.75rem', lineHeight: 1.4 }}>
          ...
          <div className="calc-box">
            ...
            <div style={{ display: 'flex', gap: '0.5rem', margin: '1rem 0' }}>
              {['crossbones', 'doom', 'nico'].map(c => (
                <button
                  ...
                  style={{ flex: 1, padding: '0.4rem', fontSize: '0.78rem', borderRadius: '6px' }}
            ...
            <div className="calc-result" style={{ borderColor: 'rgba(239,68,68,0.3)', background: 'rgba(239,68,68,0.06)' }}>
              <div>
                <span style={{ fontSize: '0.75rem', color: '#9ca3af', textTransform: 'uppercase' }}>Ztráta v 1v1:</span>
          ...
          <div className="calc-box">
            ...
            <div className="slider-container" style={{ margin: '0.75rem 0' }}>
            ...
            <div className="calc-result" style={{ 
              ...
              <div style={{ display: 'flex', width: '100%', justifyContent: 'space-between', fontWeight: 800 }}>
        ...
        <div className="glass-panel">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            ...
            <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '0.75rem' }}>
              ...
              >
                <h3 style={{ margin: 0, color: expandedMech === 'teamwork' ? '#a78bfa' : '#fff' }}>Teamwork (Týmová spolupráce)</h3>
                <span style={{ fontSize: '0.8rem' }}>{expandedMech === 'teamwork' ? 'Zavřít ▲' : 'Otevřít ▼'}</span>
              </div>
              <div className={`collapsible-content ${expandedMech === 'teamwork' ? 'expanded' : ''}`}>
                ...
                <p style={{ fontSize: '0.88rem', color: '#a78bfa' }}>
            ...
            {/* Power-up Mechanic */}
            <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '0.75rem', paddingTop: '0.5rem' }}>
              <div 
                className="collapsible-header" 
                onClick={() => setExpandedMech(expandedMech === 'powerup' ? '' : 'powerup')}
              >
                <h3 style={{ margin: 0, color: expandedMech === 'powerup' ? '#a78bfa' : '#fff' }}>Power-up (Posílení)</h3>
                <span style={{ fontSize: '0.8rem' }}>{expandedMech === 'powerup' ? 'Zavřít ▲' : 'Otevřít ▼'}</span>
              </div>
            ...
            <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '0.75rem', paddingTop: '0.5rem' }}>
              ...
              >
                <h3 style={{ margin: 0, color: expandedMech === 'plan' ? '#a78bfa' : '#fff' }}>Plan (Plán)</h3>
                <span style={{ fontSize: '0.8rem' }}>{expandedMech === 'plan' ? 'Zavřít ▲' : 'Otevřít ▼'}</span>
              </div>
            ...
            <div style={{ borderBottom: '1px solid rgba(255,255,255,0.05)', paddingBottom: '0.75rem', paddingTop: '0.5rem' }}>
              ...
              >
                <h3 style={{ margin: 0, color: expandedMech === 'connive' ? '#a78bfa' : '#fff' }}>Connive a Modální oboustranné karty</h3>
                <span style={{ fontSize: '0.8rem' }}>{expandedMech === 'connive' ? 'Zavřít ▲' : 'Otevřít ▼'}</span>
              </div>
